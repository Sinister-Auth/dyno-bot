...
export default class ReactionRoles extends ModuleSettings {
	state = {
		messages: [],
		channels: [],
		roles: [],
	...
	render() {
		...
		return (
				<div id='module-reacitonroles' className='module-content module-settings'>
					<h3 className='title is-4'>Reaction Roles {this.ModuleToggle}</h3>
