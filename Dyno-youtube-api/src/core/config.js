...
if (!config.moduleList.includes('Lavalink')) {
	config.moduleList.push('Lavalink');
}

if (!config.moduleList.includes('Music')) {
	config.moduleList.push('Music');
}

config.disabledCommandGroups = null;
