...
class Uptime extends Command {
	...
	execute({ message }) {
		...
		const embed = {
			...
			footer: {
				text: `[${this.dyno.threadId}] ${this.config.stateName} | Cluster ${this.dyno.clientOptions.clusterId.toString()} | Shard ${message.channel.guild.shard.id} | Last started on ${started}`,
			},
		};
