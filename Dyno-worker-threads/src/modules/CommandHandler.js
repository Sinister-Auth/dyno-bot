...
class CommandHandler extends Module {
	...
	messageCreate(e) {
		...
		// NOTE: I think this was unnecessary due to similar check below
		// if (guildConfig.commands.hasOwnProperty(cmd)) {
		// 	if (guildConfig.commands[cmd] === false || guildConfig.commands[cmd].enabled === false) {
		// 		return;
		// 	}
		// }
		...
		if (!this.commandGroupEnabled(module)) {
			return;
		}
